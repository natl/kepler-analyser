...
outputDir = "./example_output/" #include trailing slash
...
inputDir = "./example_data/" #include trailing slash
...
keyTable = np.genfromtxt('./example_data/MODELS.txt', dtype = dt, 
...
notAnalysable = ['xrba%s' % ii for ii in noExist]
twinPeaks = ['xrba410']
stableTrans = []
